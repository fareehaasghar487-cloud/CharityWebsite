  ...
  return (
    <section className="py-16 bg-[#f8f5f4] text-gray-900">
      <div className="container mx-auto px-4">
            ...
            >
              <div className="mb-6">
                ...
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#821435] to-[#543D2E] flex items-center justify-center mx-auto mb-4 relative shadow-lg">
                  ...
                  {step === 3 && (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04 12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                  )}
                </div>
        ...
        {/* Additional Info */}
        <div
          className="mt-16 bg-white rounded-2xl p-8 md:p-12 shadow-md border border-[#543D2E]/25"
          data-aos="fade-up"
        >
            ...
            <div className="md:w-2/3 mb-8 md:mb-0 md:pr-8">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start" data-aos="fade-right" data-aos-delay={i * 100}>
                    <div className="w-6 h-6 bg-[#821435]/20 rounded-full flex items-center justify-center flex-shrink-0 mr-3 mt-0.5">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-[#821435]" viewBox="0 0 20 20" fill="currentColor">
