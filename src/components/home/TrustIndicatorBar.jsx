...
const TrustIndicatorBar = () => {
  return (
    <div className="w-full bg-gradient-to-r from-[#821435]/10 to-[#543D2E]/10 py-12 md:py-16 border-t border-b border-[#821435]/20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-md border border-[#821435]/30 flex flex-col items-center min-h-[250px]">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-6">
              ...
              {/* SANDI */}
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-gradient-to-br from-[#543D2E] to-[#821435] rounded-xl flex items-center justify-center text-white font-bold text-xs text-center shadow-md">
                  SANDI
                </div>
          ...
          {/* Impact Statistics */}
          <div className="bg-white rounded-xl p-6 shadow-md border border-[#821435]/30 min-h-[250px] flex flex-col justify-center">
            <div className="text-center mb-5">
            ...
            <div className="grid grid-cols-2 gap-4 text-center">
              {[
                ...
                <div key={idx}>
                  <div className="text-2xl md:text-3xl font-bold text-[#543D2E]">{item.value}</div>
                  <div className="text-xs text-[#821435] mt-1 font-medium">{item.label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Security & Trust */}
          <div className="bg-white rounded-xl p-6 shadow-md border border-[#821435]/30 min-h-[250px]">
            <div className="text-center mb-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                {
                  label: "Secure", icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#543D2E]" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div key={idx} className="flex flex-col items-center">
                  ...
                  <span className="text-xs text-[#821435] mt-2 font-medium text-center">{item.label}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="mt-10 pt-8 border-t border-[#821435]/20 flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          <div className="flex items-center space-x-2 text-sm text-[#821435] font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#543D2E]" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2 bg-[#821435]/10 px-3 py-1 rounded-lg border border-[#821435]/20">
              <div className="w-5 h-5 bg-[#821435] rounded flex items-center justify-center">
                <span className="text-xs font-bold text-white">SSL</span>
              </div>
              <span className="text-xs text-[#821435]">Secure Encryption</span>
            </div>
            <div className="h-6 w-px bg-[#821435]/20"></div>
            {/* Blockchain */}
            <div className="flex items-center space-x-2 bg-[#821435]/10 px-3 py-1 rounded-lg border border-[#821435]/20">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#821435]" viewBox="0 0 20 20" fill="currentColor">
