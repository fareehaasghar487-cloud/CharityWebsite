...
export default function CampaignHeader() {
  return (
    <div className="relative w-full h-[600px] md:h-[90vh] overflow-hidden shadow-lg">
      ...
      {/* Overlay */}
      <div className="absolute w-full h-full bg-[palegreen]/80 flex items-center justify-center">
        <div className="text-center text-black px-6">
          <div data-aos="zoom-in" data-aos-duration="1000">
            <FaHandsHelping className="text-5xl md:text-6xl mx-auto mb-4 text-black" />
          </div>
          ...
          <p
            className="mt-3 text-lg md:text-xl text-black max-w-2xl mx-auto"
            data-aos="fade-up"
            data-aos-duration="1200"
            data-aos-delay="400"
          >
